...
df_size_exposed <- df_size_exposed[1:(length(df_size_exposed) - data.table::fcase(level_restriction == 0, 0,
...
cm_factor <- cm_factor[1:(length(cm_factor) - level_restriction)]
